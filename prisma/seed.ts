...
async function main() {
  ...
  const plans = [
    {
      name: 'EARLY_BIRD',
      displayName: 'Early Bird Special',
      priceINR: 0,
      monthlyPostLimit: 30,
      dailyPostLimit: 5,
      hasBulkUpload: false,
      hasApiAccess: false,
      description: 'Generous early adopter free plan with up to 30 posts per month.',
    },
    {
      name: 'FREE',
      ...
      hasBulkUpload: false,
      hasApiAccess: false,
      description: 'Standard free plan for individual bloggers and testing.',
    },
    {
      name: 'STANDARD',
      ...
      hasBulkUpload: true,
      hasApiAccess: false,
      description: 'Ideal for regular bloggers and SEO pros. 2 posts per day + Bulk CSV Upload.',
    },
    {
      name: 'PREMIUM',
      ...
      hasBulkUpload: true,
      hasApiAccess: true,
      description: 'For power agencies and startups. 3 posts/day + API key access + Bulk upload.',
    },
  ];
